...
namespace DSELib.Audio.Wave.Enums
{
    public enum Enum_Channels
    {
        Channels_Mono = 1,
        Channels_Stereo = 2
    }
    public enum Enum_BitRates
    {
        BitRates_8bit = 8,
        BitRates_16bit = 16
    }
    public enum Enum_SampleRates
    {
        SampleRates_8_0_kHz = 8000,
        SampleRates_11_025_kHz = 11025,
        SampleRates_22_05_kHz = 22050,
        SampleRates_44_1_kHz = 44100
    }

    internal enum Enum_BufferInfo
    {
        WHDR_DONE      = 0x00000001, // Buffer-Inhalt wurde verarbeitet
        WHDR_PREPARED  = 0x00000002, // Buffer wurde vorereitet
        WHDR_BEGINLOOP = 0x00000004, // [out] Ist erster Buffer!
        WHDR_ENDLOOP   = 0x00000008, // [out] Ist letzter Buffer!
        WHDR_INQUEUE   = 0x00000010  // Buffer wartet auf Verarbeitung
    }
    internal enum Enum_WaveFormats
    {
